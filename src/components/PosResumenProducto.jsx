...
const [cantidadActual, setCantidadActual] = useState(producto.usarOferta ? producto.ofertas?.cantidad || 0 : producto.vencimientos?.[0]?.cantidad || 0);
const [usarOferta, setUsarOferta] = useState(producto.usarOferta);

const { nombre, uniqueId, id } = producto;
const precio = usarOferta ? producto.ofertas?.precio_oferta : producto.precio;

// Sincronizar cantidadActual con el estado global
useEffect(() => {
    setUsarOferta(producto.usarOferta);
    setCantidadActual(producto.usarOferta 
...
const incrementarCantidad = () => {
    ...
    handleEditarCantidadPOS(uniqueId, nuevaCantidad, usarOferta); // Actualizar estado global
};
    ...
    <div className="flex justify-between shadow space-y-1 p-4 bg-white">
        ...
        <div className="m-5">
            <button
                ...
                onClick={()=> handleEliminarProductoPedido(uniqueId)}
            >
                <svg
